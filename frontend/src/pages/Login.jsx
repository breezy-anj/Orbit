    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center text-white p-4">
      <div className="max-w-md w-full bg-gray-900 p-8 rounded-2xl shadow-2xl text-center space-y-8 border border-gray-800">
        <div className="space-y-2">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">FlowSphere</h1>
          <p className="text-gray-400 text-sm">Keep friendships alive. Manage your time intelligently.</p>
        </div>
        
        <button 
          onClick={handleLogin}
          className="w-full bg-white text-gray-900 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors flex items-center justify-center gap-3 shadow-lg"
        >
